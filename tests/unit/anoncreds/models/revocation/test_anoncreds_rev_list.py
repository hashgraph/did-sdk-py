...
from did_sdk_py import AnonCredsRevList, AnonCredsRevRegDef, RevRegDefValue
from did_sdk_py.anoncreds.models.revocation import AnonCredsRevRegEntry, RevRegEntryValue
