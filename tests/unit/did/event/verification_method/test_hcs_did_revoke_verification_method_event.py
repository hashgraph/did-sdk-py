...
from did_sdk_py.did.hcs.events.owner.hcs_did_update_did_owner_event import HcsDidEventTarget
from did_sdk_py.did.hcs.events.verification_method.hcs_did_revoke_verification_method_event import (
