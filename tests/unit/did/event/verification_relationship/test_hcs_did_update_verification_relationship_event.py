...
from did_sdk_py.did.hcs.events.hcs_did_event import HcsDidEventTarget
from did_sdk_py.did.hcs.events.verification_relationship import HcsDidUpdateVerificationRelationshipEvent
