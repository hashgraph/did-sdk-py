...
from did_sdk_py.anoncreds.utils import AnonCredsObjectType, build_anoncreds_identifier
...
def mock_hcs_file_service(mocker: MockerFixture):
    MockHcsFileService = mocker.patch(
        "did_sdk_py.anoncreds.hedera_anoncreds_registry.HcsFileService", autospec=HcsFileService
    )
...
def mock_hcs_topic_service(mocker: MockerFixture):
    MockHcsTopicService = mocker.patch(
        "did_sdk_py.anoncreds.hedera_anoncreds_registry.HcsTopicService", autospec=HcsTopicService
    )
...
def mock_hcs_message_transaction(mocker: MockerFixture):
    MockHcsMessageTransaction = mocker.patch(
        "did_sdk_py.anoncreds.hedera_anoncreds_registry.HcsMessageTransaction", autospec=HcsMessageTransaction
    )
...
def mock_hcs_message_resolver(mocker: MockerFixture):
    MockHcsMessageResolver = mocker.patch(
        "did_sdk_py.anoncreds.hedera_anoncreds_registry.HcsMessageResolver", autospec=HcsMessageResolver
    )
